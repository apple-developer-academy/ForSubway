...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    /*
        ...
        Demonstrar com handleActionWithIdentifier
     */
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.gabrielcavalcante.ForSubway" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("ForSubway", withExtension: "momd")!
